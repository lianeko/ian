        ...
        hasil = client.activity(limit=20)        
         if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            client.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by IaN™ Http://line.me/ti/p/~lianekof")            
            print "Like"
          except:
            pass
        else:
		...
		if msg.text in ["Tagall"]:
         ...
         #-------------Fungsi List Group Done---------------------#
                if msg.text in ["Creator"]:              
                 ...
                 sendMessage(msg)
                 sendMessage(msg.to,"Creator şέĻғвόţ вч ίάή")                 
